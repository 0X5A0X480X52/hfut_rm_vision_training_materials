...
本手册旨在帮助已掌握 Python 基础（或 C++ 基础）的学习者，在三周时间内系统掌握 OpenCV 的核心功能与计算机视觉基础知识。
...
- **《Learning OpenCV 4》**：O'Reilly 出版的经典教材，系统讲解 OpenCV 的各个模块。
- **《OpenCV 4 计算机视觉项目实战》**：以项目驱动学习，适合实践导向的学习者。

**视频课程**：

- B 站 "OpenCV 入门到实战" 系列视频：众多 UP 主制作的优质教程，如 [OpenCV-Python 教程](https://www.bilibili.com/video/BV1PV411774y/)
- [PyImageSearch](https://pyimagesearch.com/)：国外优秀的计算机视觉博客，有大量实战教程
...
- [OpenCV 官方安装指南](https://docs.opencv.org/4.x/da/df6/tutorial_py_table_of_contents_setup.html)

####  0.3 应知应会 Checklist

- [ ] 会使用 conda/pip 安装 `opencv-python` 和 `opencv-contrib-python`
- [ ] 能在 Python 中 `import cv2` 并打印版本号
- [ ] （可选）能在 C++ 中编译运行 OpenCV 程序
...
- OpenCV 的模块划分（core、imgproc、highgui、videoio 等）
- Python 与 C++ 接口差异
- BGR 与 RGB 的默认约定
- 图像读取、显示、保存
...
- [菜鸟教程 - 图像处理基础](https://www.runoob.com/opencv/opencv-image-basic.html)
...
- [OpenCV 中文教程 - 图像平滑](https://docs.opencv.ac.cn/4.12.0/d4/d13/tutorial_py_filtering.html)
...
- [菜鸟教程 - OpenCV 视频处理](https://www.runoob.com/opencv/cpp-opencv-video.html)
...
while True:
    ...
    if cv.waitKey(30) & 0xFF == 27:  # ESC 退出
        break
